...
if show_images == 1, figure;imshow(bw);title('After minimum area check and remove false objects'); end
%=================================================
...
%     Save images
    ...
    imwrite(a1, [path '\a1Prop.bmp'], 'bmp')
    imwrite(a2, [path '\a2Prop.bmp'], 'bmp')
    imwrite(bw1, [path '\abwProp.bmp'], 'bmp')
